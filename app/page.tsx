...
import { Sparkles, MessageCircle, Book, Heart, Compass } from 'lucide-react';
import Chat from '@/components/Chat';

export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 md:p-12 bg-background relative overflow-hidden">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <h1 className="font-display text-5xl md:text-7xl font-black text-foreground leading-tight">
              Gita AI: <br />
              <span className="text-primary">Krishna Guidance</span>
            </h1>
            <p className="text-lg text-foreground/70 max-w-md leading-relaxed">
              Find solutions to life&apos;s most challenging problems through the eternal wisdom of the Bhagavad Gita, interpreted for the modern world by Gemini AI.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              { icon: MessageCircle, title: "Direct Chat", desc: "Talk to Lord Krishna" },
            ].map((feature, i) => (
          ...
          >
            <button className="gita-button flex items-center gap-2 group">
              <span>Start Journey</span>
              <Compass size={18} className="group-hover:rotate-45 transition-all" />
            </button>
      ...
      {/* Footer */}
      <footer className="mt-20 py-8 border-t border-primary/10 w-full text-center text-[10px] uppercase tracking-[0.2em] text-foreground/40 font-medium">
        © 2026 Gita AI • Wisdom of the Ages • Powered by Gemini
      </footer>
    </main>
  );
}
